...
Target: Engineers working on portal-repository-func (function app). Covers branch strategy, CI/CD triggers, and typical development flows.
...
- Setup requirements are defined in **copilot-setup-steps.yml** (runtime-only .NET SDK 10.0.400; repository checkout and restore are left to the agent)
