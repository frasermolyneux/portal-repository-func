...
public class UpdateLiveLogFileTests
{
    private readonly Mock<ILogger<UpdateLiveLogFile>> _loggerMock = new();
    private readonly FakeRepositoryApiClient _fakeRepositoryApiClient = new();
    private readonly IConfiguration _configuration;
    private readonly TelemetryClient _telemetryClient;

    public UpdateLiveLogFileTests()
    {
    ...
    private UpdateLiveLogFile CreateSut() => new(
        _loggerMock.Object,
    ...
    [Fact]
    public async Task RunUpdateLiveLogFile_WhenNoServers_ShouldCompleteSuccessfully()
    {
        var sut = CreateSut();

        await sut.RunUpdateLiveLogFile(null);
    }
}
