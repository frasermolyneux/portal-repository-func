locals {
  ...
  repository_func_identity = local.managed_identities["repository_func"]
  ...
  function_app_name         = "fn-portal-repository-func-${var.environment}-${var.location}-${random_id.environment_id.hex}"
